...
public class PolicyInfoGUI {
	...
	private void initialize() {
		...
		lbl_policyImage.setIcon(new ImageIcon("E:\\Bigdata\\∆¿ «¡∑Œ¡ß∆Æ\\[¿⁄∑·] GUIø° æ≤¿Œ ªÁ¡¯µÈ\\policyInfo.jpg"));
		...
		lbl_whatContents.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 18));
		...
		tp_site.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.BOLD, 15));
...
//		btn_goToApplication.setFont(new Font("∏º¿∫ ∞ÌµÒ", Font.PLAIN, 13));
